...
.player-controls__right button[aria-label*="${enableRepeatLabel}"]  span{
  -webkit-mask-image: var(--repeat-off-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/repeat-off.svg"));
  mask-image: var(--repeat-off-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/repeat-off.svg"));
...
.player-controls__right button[aria-label*="${disableRepeatLabel}"] span {
  -webkit-mask-image: var(--repeat-mixed-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/repeat-mixed.svg"));
  mask-image: var(--repeat-mixed-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/repeat-mixed.svg"));
...
.player-controls__right button[aria-label*="${enableOneRepeatLabel}"] span {
  -webkit-mask-image: var(--repeat-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/repeat.svg"));
  mask-image: var(--repeat-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/repeat.svg"));
  background-color: var(--spice-accent);
  mask-size: contain;
}
...
.main-playButton-PlayButton>button[aria-label*="${playLabel}"]{
  ...
  -webkit-mask-image: var(--play-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/play.svg")) !important;
  mask-image: var(--play-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/play.svg")) !important;
}
...
.player-controls__buttons>button[aria-label*="${pauseLabel}"] span {
  background-color: var(--spice-text) !important;
  -webkit-mask-image: var(--pause-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/pause.svg")) !important;
  mask-image: var(--pause-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/pause.svg")) !important;
}
...
button[aria-label="${browseLabel}"] svg {
  ...
  -webkit-mask-image: var(--compass-outline-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/compass-outline.svg"));
  mask-image: var(--compass-outline-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/compass-outline.svg"));
...
.player-controls button[aria-label="${skipBackLabel}"] {
  ...
  -webkit-mask-image: var(--prev-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/prev.svg"));
  mask-image: var(--prev-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/prev.svg"));
}

.player-controls button[aria-label="${skipForwardLabel}"] {
  background-color: var(--spice-text);
  -webkit-mask-image: var(--next-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/next.svg"));
  mask-image: var(--next-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/next.svg"));
}
...
display: none !important;
  ...
  mask-image: var(--home-outline-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/home-outline.svg"));
  -webkit-mask-image: var(--home-outline-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/home-outline.svg"));
  background-color: var(--spice-subtext) !important;
}
...
display: none !important;
  ...
  mask-image: var(--home-filled-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/home-filled.svg"));
  -webkit-mask-image: var(--home-filled-icon, url("https://cdn.jsdelivr.net/gh/OxygenEgg/wild-lucid@refs/heads/main/assets/icons/home-filled.svg"));
  background-color: var(--spice-text) !important;
}
